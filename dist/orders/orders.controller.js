...
__decorate([
    (0, roles_decorator_1.Roles)(roles_enum_1.UserRole.CUSTOMER),
    (0, common_1.Post)('orders/:id/reorder'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
...
__decorate([
    ...
    (0, common_1.Get)('business/orders'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, roles_decorator_1.Roles)(roles_enum_1.UserRole.BUSINESS),
    (0, common_1.Patch)('business/orders/:id/status'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id')),
...
__decorate([
    ...
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, order_dto_1.AssignRiderDto]),
    __metadata("design:returntype", void 0)
