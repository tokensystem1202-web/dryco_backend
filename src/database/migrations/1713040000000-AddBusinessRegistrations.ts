...
export class AddBusinessRegistrations1713040000000 implements MigrationInterface {
  name = 'AddBusinessRegistrations1713040000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."business_registrations_business_type_enum" AS ENUM('laundry', 'dry_clean')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."business_registrations_status_enum" AS ENUM('pending', 'approved', 'rejected')`,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_business_registrations_phone" ON "business_registrations" ("phone")`,
    );
  }
